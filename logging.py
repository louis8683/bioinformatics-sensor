"""
microPython-lib is licensed under various terms. Files without explicit licensing are provided under the MIT License.

MIT License (c) 2013, 2014 microPython-lib contributors.
Permission is granted free of charge to use, copy, modify, and distribute the software with proper attribution. The software is provided "as is" without any warranties.

Python License (c) 2001-2013 Python Software Foundation.
Permission is granted to use, copy, modify, and distribute under specified terms. The software is provided "as is" without warranties.

Refer to respective module directories for detailed licensing information.
"""
